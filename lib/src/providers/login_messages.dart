...
class LoginMessages with ChangeNotifier {
  ...
  static const defaultUsernameHint = 'شماره تلفن';
  static const defaultPasswordHint = 'رمز عبور';
  static const defaultConfirmPasswordHint = 'تکرار رمز عبور';
  static const defaultForgotPasswordButton = 'رمز عبور را فراموش کردی؟';
  static const defaultLoginButton = 'ورود';
  static const defaultSignupButton = 'ثبت نام';
  static const defaultRecoverPasswordButton = 'بازیابی';
  static const defaultRecoverPasswordIntro = 'رمز عبور خود را بازیابی کنید';
  static const defaultRecoverPasswordDescription =
      'ما رمز یکبار مصرف را به ایمیلتان فرستادیم';
  static const defaultGoBackButton = 'برگشت';
  static const defaultConfirmPasswordError = 'تکرار رمز عبور درست نیست!';
  static const defaultRecoverPasswordSuccess = 'کد برای شما ارسال شد';
