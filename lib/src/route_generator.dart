  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/productListFilter':
        return MaterialPageRoute(builder: (_) => ProductListFilter());
      case '/orderDetails':
        return MaterialPageRoute(builder: (_) => ShowOrderDetailsScreen());
      case '/checkOut':
      ...
      case '/showUserComment':
        return MaterialPageRoute(builder: (_) => ShowUserCommentScreen());
      case '/favoriteScreen':
